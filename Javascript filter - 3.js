...
This is the solution I came up with for the kata 'Javascript filter-method - 3':
http://www.codewars.com/dojo/katas/525f0459fb9570f9ff00005d
...
function searchNames( logins ){
  var filter = logins.filter(function(elem) {
    return (elem[0] == '.' || elem.slice(-1) == '.');
  });
  return filter.map(function(elem, index) {
    var indexInLogins = logins.indexOf(elem);
    return logins[indexInLogins+1];
  });
}